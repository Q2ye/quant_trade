...
class AnalysisEventType(str, Enum):
	"""分析模块事件类型"""
	# 通用任务生命周期事件（跨分析类型）
	ANALYSIS_TASK_STARTED = "analysis.task.started"
	ANALYSIS_TASK_PROGRESS = "analysis.task.progress"
	ANALYSIS_TASK_COMPLETED = "analysis.task.completed"
	ANALYSIS_TASK_FAILED = "analysis.task.failed"
	...
	# 报告生成事件
	REPORT_GENERATION_STARTED = "analysis.report.started"
	REPORT_GENERATION_COMPLETED = "analysis.report.completed"
	REPORT_GENERATION_FAILED = "analysis.report.failed"
