...
from quant_server.modules.monitor.constants import AlertLevel, AlertType, AlertStatus
...
class AlertService:
    ...
    async def render_template(
        ...
        """使用模板渲染告警消息"""
        from quant_server.shared.database.repositories.analysis.monitor.alert_template_repo import AlertTemplateRepository
