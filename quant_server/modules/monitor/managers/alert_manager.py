...
from quant_server.modules.monitor.constants import AlertLevel, AlertType, NotificationChannel
...
class AlertManager:
    ...
    async def dispatch(
        ...
        from quant_server.shared.database.repositories.analysis.monitor.alert_delivery_log_repo import AlertDeliveryLogRepository
