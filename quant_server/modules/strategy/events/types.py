...
class StrategyEventType(str, Enum):
	...
	PORTFOLIO_PERFORMANCE_UPDATED = "portfolio.performance_updated"
	PORTFOLIO_RISK_WARNING = "portfolio.risk_warning"
	PORTFOLIO_STRATEGY_ADDED = "portfolio.strategy_added"
	PORTFOLIO_STRATEGY_REMOVED = "portfolio.strategy_removed"
