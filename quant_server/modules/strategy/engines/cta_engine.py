...
class CTAEngine(EngineBase):
    ...
    def get_strategy(self, strategy_id: int) -> Optional[BaseStrategy]:
        """
        获取策略实例
    ...
    def get_context(self, strategy_id: int) -> Optional[StrategyContext]:
        """
        获取策略上下文
    ...
    def get_watching_symbols(self, strategy_id: int) -> List[str]:
        """
        获取策略订阅的股票列表
