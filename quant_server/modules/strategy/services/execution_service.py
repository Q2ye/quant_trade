...
from quant_server.modules.strategy.models import StrategyInstance, StrategyState
...
class ExecutionService:
    ...
    def __init__(self, session: AsyncSession):
        ...
        self._running_strategies: Dict[int, StrategyState] = {}
        ...
        try:
            ...
            return {
                ...
                "data": {
                    ...
                    "is_running": strategy.status == StrategyStatus.RUNNING,
                    "run_id": active_run.id if active_run else None,
                    "capital": active_run.capital if active_run else None,
    ...
    async def _calculate_performance(self, strategy_id: int) -> Dict[str, Any]:
        """
        计算策略绩效
