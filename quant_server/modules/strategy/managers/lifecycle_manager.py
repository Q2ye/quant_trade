...
from quant_server.modules.strategy.constants import StrategyStatus
...
class LifecycleEvent:
    ...
    def __init__(self, event_type: str, strategy_id: int, data: Any = None):
...
class LifecycleManager:
    ...
    async def unregister_strategy(self, strategy_id: int) -> None:
        """
        注销策略
    ...
    async def initialize(self, strategy_id: int) -> bool:
        """
        初始化策略
    ...
    async def stop(self, strategy_id: int, force: bool = False) -> bool:
        """
        停止策略
    ...
    async def pause(self, strategy_id: int) -> bool:
        """
        暂停策略
    ...
    async def resume(self, strategy_id: int) -> bool:
        """
        恢复策略
    ...
    def get_state(self, strategy_id: int) -> Optional[LifecycleState]:
        """
        获取策略生命周期状态
    ...
    def is_paused(self, strategy_id: int) -> bool:
        """策略是否暂停"""
