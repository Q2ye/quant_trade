...
class DataType(str, Enum):
	...
	def get_display_name (cls, data_type):
		...
		display_names = {
			# 每日行情
			cls.DAILY_QUOTES: "股票日线行情", cls.WEEKLY_QUOTES: "股票周线行情",
			cls.MONTHLY_QUOTES: "股票月线行情", cls.MINUTE_QUOTES: "股票分钟行情",
			cls.TICK_QUOTES: "Tick行情", cls.MONEYFLOW: "股票资金流向",
			cls.ADJ_FACTOR: "股票复权因子", cls.DAILY_BASIC: "股票每日指标",
			cls.SUSPEND: "每日停复牌", cls.DAILY_LIMIT: "涨跌停价格",
			cls.ST_STOCKRISK: "ST风险警示板",
			# ETF
			cls.ETF_BASIC: "ETF基本信息", cls.ETF_INDEX: "ETF跟踪指数",
			cls.ETF_DAILY: "ETF日线行情", cls.ETF_MINUTE: "ETF分钟行情",
			cls.FUND_ADJ_FACTOR: "ETF复权因子", cls.ETF_SHARE: "ETF份额规模",
			# 指数
			...
			# 财务
			cls.FINANCIAL_DATA: "财务报表(三表)", cls.FINANCIAL_INCOME: "利润表",
			cls.FINANCIAL_BALANCE: "资产负债表", cls.FINANCIAL_CASHFLOW: "现金流量表",
			cls.FORECAST: "业绩预告", cls.EXPRESS: "业绩快报", cls.DIVIDEND: "分红送股",
			cls.FINANCIAL_INDICATOR: "财务指标", cls.AUDIT_OPINION: "审计意见",
			cls.BUSINESS_INCOME: "主营业务构成", cls.DISCLOSURE_DATE: "财报披露日期",
			# 公司治理
			cls.MANAGERS: "管理层信息", cls.REWARDS: "管理层薪酬",
			cls.TOP10_HOLDERS: "前十大股东", cls.TOP10_FLOAT_HOLDERS: "前十大流通股东",
			cls.STK_HOLDERNUMBER: "股东人数", cls.PLEDGE_STAT: "股权质押统计",
			cls.STK_HOLDERTRADE: "股东增减持", cls.SHARE_FLOAT: "限售股解禁",
			cls.FORECAST_PRO: "券商盈利预测",
			# 基础数据
			cls.STOCK_LIST: "股票列表", cls.CALENDAR: "交易日历",
			cls.COMPANY: "上市公司信息", cls.STOCK_HSGT: "沪深港通列表",
			# 宏观
