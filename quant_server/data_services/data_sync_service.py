...
def _get_test_data(data_type: str, **kwargs) -> List[Dict]:
    ...
    if data_type == "stock_basic":
        return [
            {"ts_code": "000001.SZ", "symbol": "000001", "name": "平安银行", "area": "深圳", "industry": "银行", "list_date": "19910403","market":"主板"},
            {"ts_code": "000002.SZ", "symbol": "000002", "name": "万科A", "area": "深圳", "industry": "全国地产", "list_date": "19910129","market":"主板"},
            {"ts_code": "000004.SZ", "symbol": "000004", "name": "国农科技", "area": "深圳", "industry": "生物制药", "list_date": "19910114","market":"主板"},
            {"ts_code": "000005.SZ", "symbol": "000005", "name": "世纪星源", "area": "深圳", "industry": "房产服务", "list_date": "19901210","market":"主板"},
            {"ts_code": "000006.SZ", "symbol": "000006", "name": "深振业A", "area": "深圳", "industry": "区域地产", "list_date": "19920427","market":"主板"},
            {"ts_code": "000007.SZ", "symbol": "000007", "name": "全新好", "area": "深圳", "industry": "酒店餐饮", "list_date": "19920413","market":"主板"},
            {"ts_code": "000008.SZ", "symbol": "000008", "name": "神州高铁", "area": "北京", "industry": "运输设备", "list_date": "19920507","market":"主板"},
            {"ts_code": "000009.SZ", "symbol": "000009", "name": "中国宝安", "area": "深圳", "industry": "综合类", "list_date": "19910625","market":"主板"},
            {"ts_code": "000010.SZ", "symbol": "000010", "name": "美丽生态", "area": "深圳", "industry": "建筑施工", "list_date": "19951027","market":"主板"},
            {"ts_code": "000011.SZ", "symbol": "000011", "name": "深物业A", "area": "深圳", "industry": "区域地产", "list_date": "19920330","market":"主板"},
            {"ts_code": "000012.SZ", "symbol": "000012", "name": "南玻A", "area": "深圳", "industry": "玻璃", "list_date": "19920228","market":"主板"},
            {"ts_code": "000014.SZ", "symbol": "000014", "name": "沙河股份", "area": "深圳", "industry": "全国地产", "list_date": "19920602","market":"主板"},
            {"ts_code": "000016.SZ", "symbol": "000016", "name": "深康佳A", "area": "深圳", "industry": "家用电器", "list_date": "19920327","market":"主板"},
            {"ts_code": "000017.SZ", "symbol": "000017", "name": "深中华A", "area": "深圳", "industry": "文教休闲", "list_date": "19920331","market":"主板"},
            {"ts_code": "000018.SZ", "symbol": "000018", "name": "神州长城", "area": "深圳", "industry": "装修装饰", "list_date": "19920616","market":"主板"},
            {"ts_code": "000019.SZ", "symbol": "000019", "name": "深深宝A", "area": "深圳", "industry": "软饮料", "list_date": "19921012","market":"主板"},
            {"ts_code": "000020.SZ", "symbol": "000020", "name": "深华发A", "area": "深圳", "industry": "元器件", "list_date": "19920428","market":"主板"},
            {"ts_code": "000021.SZ", "symbol": "000021", "name": "深科技", "area": "深圳", "industry": "电脑设备", "list_date": "19940202","market":"主板"},
            {"ts_code": "000022.SZ", "symbol": "000022", "name": "深赤湾A", "area": "深圳", "industry": "港口", "list_date": "19930505","market":"主板"},
            {"ts_code": "000023.SZ", "symbol": "000023", "name": "深天地A", "area": "深圳", "industry": "其他建材", "list_date": "19930429","market":"主板"},
            {"ts_code": "000025.SZ", "symbol": "000025", "name": "特力A", "area": "深圳", "industry": "汽车服务", "list_date": "19930621","market":"主板"}
        ]
...
class DataSyncService:
    ...
    def __init__(self, session: Session = None):
        ...
        # 初始化所有服务
        self.stock_basic_service = StockBasicService(self.session)
        self.stock_company_service = StockCompanyService(self.session)
        self.stk_manager_service = StkManagerService(self.session)
        self.stk_reward_service = StkRewardService(self.session)
        self.stock_daily_service = StockDailyService(self.session)
        self.stock_weekly_service = StockWeeklyService(self.session)
        self.stock_monthly_service = StockMonthlyService(self.session)
        self.stock_adj_factor_service = StockAdjFactorService(self.session)
        self.stock_daily_basic_service = StockDailyBasicService(self.session)
        self.stock_daily_limit_service = StockDailyLimitService(self.session)
        self.stock_moneyflow_service = StockMoneyflowService(self.session)
    ...
    def sync_stk_managers(self, ts_code: str = '', ann_date: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.stk_manager_service.batch_create(data)
    ...
    def sync_stk_rewards(self, ts_code: str = '', end_date: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.stk_reward_service.batch_create(data)
        ...
        if self.is_test_env:
            ...
            try:
                ...
                if test_data:
                    # 根据数据类型调用不同的服务保存数据
                    if data_type == "daily":
                        results.extend(self.stock_daily_service.batch_create(test_data))
                    elif data_type == "weekly":
                        results.extend(self.stock_weekly_service.batch_create(test_data))
                    elif data_type == "monthly":
                        results.extend(self.stock_monthly_service.batch_create(test_data))
                    elif data_type == "adj_factor":
                        results.extend(self.stock_adj_factor_service.batch_create(test_data))
                    elif data_type == "daily_basic":
                        results.extend(self.stock_daily_basic_service.batch_create(test_data))
                    elif data_type == "moneyflow":
                        results.extend(self.stock_moneyflow_service.batch_create(test_data))
        ...
        for code in batch_codes:
            try:
                ...
                if data_type == "daily":
                    ...
                    if data:
                        success_results.extend(self.stock_daily_service.batch_create(data))
                    ...
                    if data:
                        success_results.extend(self.stock_weekly_service.batch_create(data))
                    ...
                    if data:
                        success_results.extend(self.stock_monthly_service.batch_create(data))
                    ...
                    if data:
                        success_results.extend(self.stock_adj_factor_service.batch_create(data))
                    ...
                    if data:
                        success_results.extend(self.stock_daily_basic_service.batch_create(data))
                    ...
                    if data:
                        success_results.extend(self.stock_moneyflow_service.batch_create(data))
    ...
    def sync_daily_data(self, days: int = 30, stock_codes: List[str] = None,
        ...
        return self._sync_stock_data_parallel(
    ...
    def sync_fund_basic(self, market: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.etf_basic_service.batch_create(data)
    ...
    def sync_fund_daily(self, days: int = 30, ts_codes: List[str] = None) -> Dict[str, Any]:
        ...
        for code in ts_codes:
            try:
                ...
                if data:
                    results.extend(self.etf_daily_service.batch_create(data))
    ...
    def sync_all_data(self, days: int = 30, batch_size: int = 100) -> Dict[str, Any]:
        ...
        results = {"stock_basic": self.sync_stock_basic(), "stock_company": self.sync_stock_company(),
                   ...
                   "fund_basic": self.sync_fund_basic(), "fund_daily": self.sync_fund_daily(days=days)}
