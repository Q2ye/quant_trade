...
| 文件 | 职责 |
|:---|:---|
| `docs/02-功能设计/策略体系/回测分析标准流程.md` | 回测七步分析（所有策略通用） |
| `docs/02-功能设计/策略体系/策略运行分析标准流程.md` | 实盘/日终运行分析七步 |
| `docs/02-功能设计/策略体系/策略实盘准入标准.md` | **准入唯一规则**：六道门 G0–G5 + 三级实盘 + 分层 20 项 |
| `docs/02-功能设计/策略体系/策略过拟合检验标准.md` | 试验台账 / 样本外 / 安慰剂 / PBO / Deflated Sharpe / Purging |
| `docs/02-功能设计/策略体系/策略盘查框架.md` | A1–C3 十检查块盘查方法论 |
| `docs/02-功能设计/数据模块/数据质量标准.md` | 数据五道门（完整性/正确性/PIT/停牌/运行期） |
| `docs/02-功能设计/策略体系/因子研究标准流程.md` | 因子研究 → 注册 → 落库 → 消费全链路 |
