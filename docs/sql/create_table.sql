...
CREATE TABLE stock_moneyflow (
    ...
    trade_date DATE NOT NULL,
    buy_sm_vol INT,
    buy_sm_amount NUMERIC(18,6),
    sell_sm_vol INT,
    sell_sm_amount NUMERIC(18,6),
    buy_md_vol INT,
    buy_md_amount NUMERIC(18,6),
    sell_md_vol INT,
    sell_md_amount NUMERIC(18,6),
    buy_lg_vol INT,
    buy_lg_amount NUMERIC(18,6),
    sell_lg_vol INT,
    sell_lg_amount NUMERIC(18,6),
    buy_elg_vol INT,
    buy_elg_amount NUMERIC(18,6),
    sell_elg_vol INT,
    sell_elg_amount NUMERIC(18,6),
    net_mf_vol INT,
    net_mf_amount NUMERIC(18,6),
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (ts_code, trade_date)
);
...
CREATE TABLE stock_forecasts (
    ...
    type VARCHAR(10),
    p_change_min NUMERIC(18,6),
    p_change_max NUMERIC(18,6),
...
CREATE TABLE stock_dividends (
    ...
    stk_bo_rate NUMERIC(18,6),
    stk_co_rate NUMERIC(18,6),
...
CREATE TABLE stock_top10_holders (
    ...
    hold_ratio NUMERIC(18, 4),
    hold_float_ratio NUMERIC(18, 4),
    hold_change NUMERIC(18, 4),
...
CREATE TABLE stock_factor_daily (
    ...
    open_hfq NUMERIC(18, 6),
    open_qfq NUMERIC(18, 6),
    close_hfq NUMERIC(18, 6),
    close_qfq NUMERIC(18, 6),
    high_hfq NUMERIC(18, 6),
    high_qfq NUMERIC(18, 6),
    low_hfq NUMERIC(18, 6),
    low_qfq NUMERIC(18, 6),
