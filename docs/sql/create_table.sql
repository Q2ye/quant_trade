...
CREATE TABLE stock_moneyflow (
    ...
    trade_date DATE NOT NULL,
    buy_sm_vol INT,
    buy_sm_amount NUMERIC(12,4),
    sell_sm_vol INT,
    sell_sm_amount NUMERIC(12,4),
    buy_md_vol INT,
    buy_md_amount NUMERIC(12,4),
    sell_md_vol INT,
    sell_md_amount NUMERIC(12,4),
    buy_lg_vol INT,
    buy_lg_amount NUMERIC(12,4),
    sell_lg_vol INT,
    sell_lg_amount NUMERIC(12,4),
    buy_elg_vol INT,
    buy_elg_amount NUMERIC(12,4),
    sell_elg_vol INT,
    sell_elg_amount NUMERIC(12,4),
    net_mf_vol INT,
    net_mf_amount NUMERIC(12,4),
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (ts_code, trade_date)
);
