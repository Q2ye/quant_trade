    ...
    render: (row) => {
      if (row.consecutive_days > 1) {
        return h(
          "n-tag",
          { type: "primary" },
          { default: () => `${row.consecutive_days}天` },
        );
      }
      return "-";
    },
    ...
    <NLayoutHeader class="page-header">
      <div class="header-content">
        ...
        <div class="header-actions">
          <NButton :loading="loading" @click="refreshData" class="refresh-btn">
            <template #icon>
              <NIcon>
          ...
          <NGrid :cols="4" :x-gap="16" class="stats-section">
            <NGridItem>
              <NCard class="stats-card">
                <NStatistic label="涨停数量" :value="stats.upLimitCount">
                  <template #prefix>
                    <NIcon class="stats-icon up" :component="ArrowUp" />
                  </template>
                </NStatistic>
              </NCard>
            </NGridItem>
            <NGridItem>
              <NCard class="stats-card">
                <NStatistic label="跌停数量" :value="stats.downLimitCount">
                  <template #prefix>
                    <NIcon class="stats-icon down" :component="ArrowDown" />
                  </template>
                </NStatistic>
              </NCard>
            </NGridItem>
            ...
            <NGridItem>
              <NCard class="stats-card">
                ...
                >
                  <template #prefix>
                    <NIcon class="stats-icon ratio" :component="PieChart" />
                  </template>
                </NStatistic>
              </NCard>
            </NGridItem>
            ...
            <template #header-extra>
              <NButton @click="toggleViewMode" class="view-toggle-btn">
                <template #icon>
                  <NIcon>
                    <component
                      :is="viewMode === 'table' ? BarChartIcon : Grid"
                    />
                  </NIcon>
                </template>
