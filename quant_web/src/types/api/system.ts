// quant_web/src/types/api/system.ts
// 系统管理API类型定义
 ...
 * 系统日志查询参数
 */
export interface SystemLogQueryParams extends PaginationParams, TimeRangeParams {
...
export interface DataSourceStatusResponse extends ApiResponse<DataSourceStatus[]> {}
