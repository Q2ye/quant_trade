<template>
  <div class="industry-strength-chart">
    <div class="chart-controls">
      ...
      >
        <NRadioButton value="5d">5日</NRadioButton>
        <NRadioButton value="20d">20日</NRadioButton>
        <NRadioButton value="60d">60日</NRadioButton>
      </NRadioGroup>
    </div>
...
const updateChart = () => {
  ...
  const currentField = fieldMap[timeRange.value as keyof typeof fieldMap];
  const sortedData = [...props.data].sort(
    (a, b) => b[currentField] - a[currentField],
  );
